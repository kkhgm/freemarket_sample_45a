$(function(){
  function buildChild(cateChild){
    var html =`<select class="item-contents__item-about_box_condition_input" id="child" name="item[condition]"></select>`
    return html;}

  function buildGrandChild(cateChild){
    var html =`<select class="item-contents__item-about_box_condition_input" id="grand_child" name="item[condition]"></select>`
    return html;}
